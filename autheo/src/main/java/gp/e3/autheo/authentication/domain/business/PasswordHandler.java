...
public class PasswordHandler {
	...
	public static String getSaltFromHashedAndSaltedPassword(String hashedAndSaltedPassword) throws IllegalArgumentException {
		...
		if (!StringUtils.isBlank(hashedAndSaltedPassword)) {
	 ...
	 * @throws InvalidKeySpecException
	 */
	public static boolean validatePassword(String password, String correctHash) throws NoSuchAlgorithmException, InvalidKeySpecException, IllegalArgumentException {

		if (!StringUtils.isBlank(password) && !StringUtils.isBlank(correctHash)) {
