...
public class TokenMySQLFactory implements ITokenSQLFactory {
	...
	public String getCreateTokensTableIfNotExistsSQL() {
		...
		return "CREATE TABLE IF NOT EXISTS tokens (token_value varchar(128), username varchar(32), "
				+ "organization_id varchar(32), role_id varchar(32), token_type TINYINT(10), documenttype varchar(32), documentnumber varchar(32), "
				+ "system_role varchar(32), PRIMARY KEY (organization_id, token_type));";
	}
