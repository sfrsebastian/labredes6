...
public class PermissionMySQLFactory implements IPermissionSQLFactory {

	@Override
	public String getCreatePermissionsUniqueIndexSQL() {
		
		return "ALTER TABLE permissions ADD UNIQUE INDEX(http_verb, url);";
	}

	@Override
	public String getCreatePermissionsTableIfNotExistsSQL() {
		
		return "CREATE TABLE IF NOT EXISTS permissions (id INT AUTO_INCREMENT, name VARCHAR(32), http_verb VARCHAR(32), url VARCHAR(256), PRIMARY KEY (id));";
	}
