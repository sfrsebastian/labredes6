...
public class RequestFilter implements Filter {
	...
	private HttpResponse getAuthorizationResponse(CloseableHttpClient httpClient, TicketDTO ticketDto) throws IOException, ClientProtocolException {
	...
	public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse,
		...
		if (httpVerb.equalsIgnoreCase("OPTIONS")) {
			...
			HttpResponse authorizationResponse = getAuthorizationResponse(httpClient, ticketDto);
			...
			if (authorizationStatusCode == 200) {
				...
				String responseEntityString = EntityUtils.toString(authorizationResponseEntity);
				httpResponse.getWriter().write(responseEntityString);
